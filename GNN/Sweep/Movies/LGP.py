...
sweep_configuration = {
    "method": "grid",
    "name": "Movies-RevGAT-LGP",
    "metric": {"goal": "maximize", "name": "Mean_Val_accuracy"},
    "parameters": {
        "LLM_feature": {"values": ["/dataintent/local/user/v-yinju/haoyan/Data/Movies/Feature/Movies_Llama_2_13b_hf_256_mean.npy"]},
        "PLM_feature": {"values": ["/dataintent/local/user/v-yinju/haoyan/Data/MoviesFeature/Movies_roberta_base_512_Tuned_cls.npy"]},
        "dropout": {"values": [0.5]},
        "edge-drop": {"value": 0.3},
        "attn-drop": {"value": 0.0},
