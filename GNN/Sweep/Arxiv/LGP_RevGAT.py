...
sweep_configuration = {
    "method": "grid",
    "name": "Arxiv-RevGAT-LGP",
    "metric": {"goal": "maximize", "name": "Mean_Val_accuracy"},
    "parameters": {
        "LLM_feature": {"values": ["/dataintent/local/user/v-yinju/haoyan/Data/OGB/Arxiv/Feature/Arxiv_Llama_2_13b_hf_256_mean.npy"]},
        "PLM_feature": {"values": ["/dataintent/local/user/v-yinju/haoyan/Data/OGB/Arxiv/Feature/Arxiv_roberta_base_512_Tuned_cls.npy"]},
        "dropout": {"values": [0.5]},
        "edge-drop": {"value": 0.3},
        "attn-drop": {"value": 0.0},
