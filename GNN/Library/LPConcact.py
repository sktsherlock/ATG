...
def main():
    ...
    if args.gnn == 'RevGAT':
        GNN = RevGAT(concatenated_feat.shape[1], n_classes, args.n_hidden, args.n_layers, args.n_heads, F.relu,
        ...
        GNN = GCN(concatenated_feat.shape[1], args.n_hidden, n_classes, args.n_layers, F.relu,
                  dropout=args.dropout).to(device)
    elif args.gnn == 'SAGE':
        GNN = GraphSAGE(concatenated_feat.shape[1], args.n_hidden, n_classes, args.n_layers, F.relu,
    ...
    for run in range(args.n_runs):
        ...
        val_result, test_result = classification(
            args, graph, GNN, concatenated_feat, labels, train_idx, val_idx, test_idx, run + 1
        )
