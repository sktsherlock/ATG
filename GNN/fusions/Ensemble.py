...
def ensembling(text_feature_path, image_feature_path, args, labels, train_idx, val_idx, test_idx, metric, c_and_s=False):
    # 加载预测文件
...
def compute():
    ...
    for seed in range(args.start_seed, args.start_seed + 10):
        ...
        train_acc, val_acc, test_acc = ensembling(text_feature_path, image_feature_path, args, labels, train_idx, val_idx, test_idx, args.metric, c_and_s=args.c_and_s)
