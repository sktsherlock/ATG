"""Implements common fusion patterns in the MultiBench Github."""
...
class LowRankTensorFusion(nn.Module):
    ...
    def reset_parameters(self):
        """Reset the parameters of the LowRankTensorFusion module."""
...
class NLgate(torch.nn.Module):
    ...
    def reset_parameters(self):
        """Reset the parameters of the NLgate module."""
        if self.qli is not None:
            self.qli.reset_parameters()
        if self.kli is not None:
            self.kli.reset_parameters()
        if self.vli is not None:
            self.vli.reset_parameters()
...
class EarlyFusionTransformer(nn.Module):
    ...
    def reset_parameters(self):
        """Reset the parameters of the LateFusionTransformer."""
